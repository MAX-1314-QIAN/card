...
vm.runInContext("runController.startRun('RUN_TEMPLATE_SYSTEM_TEST');currentEncounter=null;bossOpeningBonus=0;equippedPersonaIds=[];ensurePersonaRuntimeInitialized(true)",context);
...
vm.runInContext("bossOpeningBonus=20;equippedPersonaIds=['collector'];ensurePersonaRuntimeInitialized(true);personaRuntime.processDiscard(4,{commit:true})",context);
