...
context.buildRunSaveState=()=>({runState:context.runController.serializeState(),battleIndex:0,coins:0,runDeck:[card],deck:[card],hand:[card],usedCards:[],discardedCards:[],score:123,currentEncounter:{rule:{id:'repeat_judgment'},event:{id:'extra_chance'}},equippedPersonaIds:['observer']});
