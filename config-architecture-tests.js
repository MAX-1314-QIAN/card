...
assert.strictEqual(manifest.configVersion,'phase-c.3-ai-persona-local-v1-economy-v2-shop-refresh-v2');
assert.strictEqual(manifest.targetEconomy.id,'TARGET_ECONOMY_V2');
