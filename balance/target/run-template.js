(function(root){
  ...
  modules.targetRunTemplate={id:'RUN_TEMPLATE_TARGET',runTemplateId:'RUN_TEMPLATE_TARGET',startNodeId:'TARGET_PERSONA_SELECT',nodeIds:['TARGET_PERSONA_SELECT','N01','N02','N03','N04','N05','N06','N07','N08','N09','N10','N11','N12','N13','TARGET_RUN_REPORT','TARGET_PERSONA_CARRY_OUT'],coreNodeIds:['N01','N02','N03','N04','N05','N06','N07','N08','N09','N10','N11','N12','N13'],endCondition:{type:'NODE_COMPLETED',nodeId:'TARGET_PERSONA_CARRY_OUT'},scoringProfileId:'POKER_HAND_PROFILE_TARGET_V1',actionRules:modules.targetActionRules,targetDurationMinutes:25,targetDurationDecisionStatus:'CONFIRMED',decisionStatus:'PROTOTYPE_ASSUMPTION',version:1,developmentOnly:true};
})(globalThis);
